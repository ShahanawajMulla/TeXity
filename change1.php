...
<html lang="en-US">
<head>
<title>TeXity  | Edit Product Information </title>
<meta charset="UTF-8">
...
<div id="container">
  ...
  <div id="wrapper">
	...
	<li><p><a href="admin.php"><input type="submit" name="Back" value="Back"></a></p></li> 
      ...
      <h1> Edit the Products Information </h1>
    </div>
	

		<hr><hr>   <h1>    Company Product  Name  </h1>
	<hr><hr>
		<br><br><br>
...
$rs = mysql_query ($sqlq); 
while (@$row = mysql_fetch_assoc($rs)) {echo "*";	echo '<a id="link" href="edit.php?id='.$row['id'].'">'.$row['name'].'</a></br>'; }
?>  
<br><br><br>
...
<br><br><br>
	<hr><h3><center>Bleaching Processing companies</center></h3><hr>
...
<br><br><br>
	<hr><h3><center>Finishing Processes</center></h3><hr>
